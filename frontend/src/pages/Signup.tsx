...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 px-6 lg:px-8 relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[800px] h-[800px] bg-indigo-600/10 blur-[150px] rounded-full"></div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-sm uppercase tracking-widest font-bold">Start your trading journey</p>
        </div>
            ...
            <div>
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="johndoe"
                />
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground group-focus-within:text-blue-400 transition-colors" />
              </div>
            </div>

            <div>
              <label className="block text-sm font-bold text-muted-foreground mb-2 px-1">Email Address</label>
              <div className="relative group">
                <input
                  type="email"
                  required
